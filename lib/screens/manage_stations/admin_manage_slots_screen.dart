...
import '../../controllers/admin_manage_slots_controller.dart';
...
class AdminManageSlotsScreen extends StatelessWidget {
  AdminManageSlotsScreen({Key? key}) : super(key: key);

  final AdminManageSlotsController _controller = Get.put(AdminManageSlotsController());
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: [
                          CardRichText(
                            boldText: "Voltage : ",
                            normalText: "${slot.voltage} kW",
                          ),
                          const SizedBox(height: DimenConstants.contentPadding),
                          CardRichText(
                            boldText: "Price : ",
                            normalText: "${double.tryParse(slot.price ?? '0')?.toStringAsFixed(1) ?? 'N/A'} ils/min",
                          ),
                        ],
                      ),
                    ),
