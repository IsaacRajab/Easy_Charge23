...
import '../../controllers/find_stations_controller.dart';
...
class FindStationsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (_controller.bottomSheetOpen.value == false) {
  ...
  Widget _stationCards(Stations station) {
    return InkWell(
      onTap: () =>  _controller.onTapStationCard(station: station),
      child: Container(
  ...
  void _showBottomSheet() {
    _controller.bottomSheetOpen.value = true;
    Future<void> bottomSheet = showModalBottomSheet<void>(
      ...
      builder: (BuildContext buildContext) {
        return SafeArea(child: _filterValues());
      },
    );
  ...
  Widget _submitButton() {
    return Align(
      ...
      child: CustomButton(
        buttonText: "Submit",
        onButtonPressed: () {
          _controller.onButtonPressSubmit(formKey: _formKey);
        },
      ),
    );
  }
