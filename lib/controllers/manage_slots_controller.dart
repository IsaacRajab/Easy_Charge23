...
import '../screens/user_find_stations/ev_vehicle_dialog.dart';
...
class ManageSlotsController extends GetxController {
    ...
    Get.dialog(
      CommonDialog(
        ...
        contentWidget: SizedBox(
          ...
          width: Get.width,
          child: EvVehicleDialog(controller: this, slot: slot),
        ),
  ...
  Future<void> onTapVehicle({
    ...
    try {
      ...
      Get.toNamed(RouteConstants.paymentPageScreen, arguments: bookings);
